...
def Findcolor():
    ...
    colors.itemconfig(idl, fill=color1)
...
idl = colors.create_rectangle((10,10,50,50),fill="#b8255f")
...
hexl=Label(colors,text="#b8255f",fg="#000",font="arial 12 bold",bg="white")
hexl.place(x=60,y=15)
